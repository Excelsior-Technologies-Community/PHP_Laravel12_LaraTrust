    ...
    <div class="min-h-screen bg-gray-950 text-white py-10">
        ...
        <div class="max-w-3xl mx-auto px-6">
            ...
            <div class="mb-8">
                ...
                <h1 class="text-4xl font-bold mt-4">➕ Add Permission</h1>
            </div>
                ...
                <form method="POST" action="{{ route('permissions.store') }}" class="space-y-6">
                    ...
                    <div>
                        ...
                        <textarea name="description" rows="3"
                            class="w-full bg-gray-800 border border-gray-700 rounded-xl px-4 py-3 focus:ring-2 focus:ring-indigo-500 focus:outline-none">{{ old('description') }}</textarea>
                        @error('description')
                        <p class="text-red-400 text-sm mt-1">{{ $message }}</p>
                        @enderror
                    </div>
